...
1. **Check Documentation**: Review the guides in `documentation/` folder
2. **Read Error Messages**: Frontend shows user-friendly errors
3. **Check Troubleshooting**: Each guide has troubleshooting section
4. **Review Logs**: Check terminal output for details
...
# Top center should show "Sepolia test network"

# Verify Sepolia ETH balance
# Should have at least 0.1 ETH for deployment + minting
```
...
- [ ] Contract is deployed and verified on Etherscan
- [ ] Contract address documented in README.md
- [ ] Frontend runs without errors
- [ ] Can connect wallet successfully
- [ ] Can mint NFT with proper metadata
- [ ] `ownerOf()` function works and verifiable
- [ ] Metadata includes artist name (asebrech) and "42"
- [ ] Code is well-commented
- [ ] Documentation is complete
- [ ] Security considerations understood
- [ ] Can explain the minting flow
- [ ] Can demonstrate ownership verification
...
- View NFTs on blockchain explorers
- Explain the entire flow to evaluators
